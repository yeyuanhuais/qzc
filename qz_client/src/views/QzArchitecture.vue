	...
	<div class="situation">
		<div class="mainHead">
			...
			<el-breadcrumb separator-class="el-icon-arrow-right">
				...
				<el-breadcrumb-item>泉州建筑</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<div class="mainBody">
			<div class="box">
				<div class="listDiv" v-for="item in architectures" :key="item.id" v-show="item.isShow">
					<p>
						<router-link :to="'/qzArchitecture/'+item.id" :title="item.title">{{item.title|ellipsis}}</router-link>
					...
					<div>
						...
						<router-link :to="'/qzArchitecture/'+item.id" class="righta">
							<span
								class="right"
...
export default {
	...
	computed: {
		...mapState(['architectures', 'articleCount'])
	},

	mounted() {
		this.$store.dispatch('getArchitectureList', this.query)
	},
	created() {},
	methods: {
